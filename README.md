...
## Badge for Github action to reflect the build status

![Build Status](https://github.com/Amrutapavan/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
